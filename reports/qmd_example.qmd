...
```{r horse-populations, echo=FALSE, fig.cap="Horse populations for all provinces in Canada from 1906 - 1972.", fig.align='center', label=fig-horse-pops}
...
```{r largest-sd-plot, echo=FALSE, fig.cap=paste("Horse populations for the province with the largest standard deviation (", largest_sd, ")"), fig.width=6, fig.height=4, out.width="65%", fig.align='center', label=fig-largest-sd}
